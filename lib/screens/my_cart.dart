           ...
           itemBuilder: (context, index) {
             ...
             return Container(
               ...
               child: Row(
                 ...
                 children: [
                   Expanded(child: Image.network("${dataList?.featuredImage}",height: 100,width: 100,),flex: 3),
                               ...
                               children: [
                                 Container(
                                   ...
                                   child: OutlinedButton(
                                     onPressed: () async {
                                       await cartDataBloc.modifycartItems(dataList?.id, -1);
                                     },
                                     child: Text(
                                       "-",
                                       style: TextStyle(
                                           color: Color.fromRGBO(122, 176, 42, 1)),
